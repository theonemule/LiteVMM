...
${commandLine(ci)} < user-data`;
  ...
  async function loadAdmin() {
    ...
    const certbotButton=status.certbot_available
      ? '<button id="configureCertBtn" class="btn btn-primary">Let’s Encrypt</button>'
      : '<button class="btn btn-outline-secondary" disabled title="Install Certbot to use Let’s Encrypt">Let’s Encrypt unavailable</button>';
