...
COPY bin/peerctl bin/vmbackupctl bin/replicationctl bin/peer-volumectl bin/backplanectl bin/metricsctl bin/logctl bin/certctl /usr/local/bin/
...
RUN chmod 0755 /usr/local/bin/peerctl /usr/local/bin/vmbackupctl /usr/local/bin/replicationctl /usr/local/bin/peer-volumectl /usr/local/bin/backplanectl /usr/local/bin/metricsctl /usr/local/bin/logctl /usr/local/bin/certctl \
