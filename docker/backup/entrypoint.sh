...
mkdir -p /var/lib/vmapi/{backups,replicas,replication-jobs,replication-receivers,peers,identity,backup-jobs} /var/log/vmapi/backups /var/log/vmapi /run/vmapi /run/vmapi/conf.d /run/vmapi-replication /etc/lighttpd
